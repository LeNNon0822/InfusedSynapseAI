      ...
      <div class="themeContent">
        <div class="listItemContainer">
          ...
          <div class="listItemLink">
            <div class="listItemBtn" @click="routeTo('/template/1')">&#10142; Read More</div>
          </div>
        </div>
        <!-- <ul>
          <li></li>
...
.listItemContainer {
  ...
  border-top: 0.125vmax #00000077 solid;
  border-bottom: 0.125vmax #00000077 solid;
}
/* .listItemImage {
  position: relative;
  width: 40%;
